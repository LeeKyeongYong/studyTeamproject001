			...
			<div class="row">
				<div class="col-lg-3">
					<div class="blog__item">
						...
						<div class="blog__item__pic">
							<img src="파일" alt="이미지경로">
						</div> 
						-->
						<div class="blog__item__text">
							<!-- 
							<ul>
								<li><i class="fa fa-calendar-o"></i> 20220820145330</li>
								<li><i class="fa fa-comment-o"></i> 5명</li>
							</ul>
							<h5> 
				...
				<div class="col-lg-9">
					<!-- <div class="hero__search"> -->
					 <!-- 검색창  -->
					 	<form action="../purchaseWrite.do" method="post" enctype="multipart/form-data"> 
							<table class="table">
							  <thead>
							    <tr>
							      <th scope="col">판매제목</th>
							      <th><input type="text" name="product"></th>
							    </tr>
							  </thead>
							  <tbody>
							    <tr>
							      <th scope="row" scope="col">금액</th>
							    ...
							    <tr>
							      <th scope="row">사진</th>
							      <td><input type="file" name="photo" size="80"></td>
							    </tr>
							    <tr>
							      <th scope="row">이메일</th>
							    ...
							    <tr>
							      <th scope="row">주소</th>
							      <td><input type="text" name="stateaddr"></td>
							    </tr>
							    <tr>
							      <th scope="row">참여인원</th>
							      <td><input type="text" name="memberCount">&nbsp;명</td>
							    </tr>
							    <tr>
							      <th scope="row">박스수</th>
							      <td><input type="text" name="boxCount"></td>
							    </tr>
							    <tr>
							      <th scope="row">상품내역</th>
							      <td><textarea name="pdetails" cols="100" rpws="100"></textarea></td>
							    </tr>
							  </tbody>
							  	<tr>
							      <th scope="row"></th>
							      <td><button type="submit" class="btn btn-primary">구매신청</button>
							      <button type="button" class="btn btn-info">구매자확인</button>
							      </td>
							    </tr>
							  </tbody>
							</table>
