		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<c:forEach items="${farmerList}"  var="FarmerVO">
						...
						<div class="blog__item__text">
							...
							<h5>
								<a href="purchaseView.do?farmerseq=${FarmerVO.farmerseq}">&nbsp;${FarmerVO.product}</a>
							</h5>
						...
						<a href="/Foodsharing/purchase/purchaseWrite.jsp">&nbsp;등록</a>
