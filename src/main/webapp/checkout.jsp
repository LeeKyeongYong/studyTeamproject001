                            ...
                            <div class="checkout__input__checkbox">
                              ...
                              <div class="col-lg-4 col-md-6">
		                            <div class="checkout__order">
		                                ...
		                                <ul>
		                                    <li>신선한 야채 <span>0원</span></li>
		                                    <li>유기농 바나나 <span>0원</span></li>
		                                </ul>
		                                <div class="checkout__order__subtotal">소계 <span>0원</span></div>
		                                <div class="checkout__order__total">총 금액 <span>0원</span></div>
