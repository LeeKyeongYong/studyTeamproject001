...
<body>
	...
	<!-- Header Section end -->
    	<section class="featured spad">
	        <div class="container">
	        	<div class="col-lg-3">
	        		<form action="../communittyWrite.do" method="post" enctype="multipart/form-data"> 
							<table class="table">
							  <thead>
							    <tr>
							      <th scope="col">작성자</th>
							      <th>이경용(sleekydz86@icloud.com)</th>
							    </tr>
							  </thead>
							  <tbody>
							    <tr>
							    ...
							    <tr>
							      <th scope="row">파일</th>
							      <td><input type="file" name="articleFile" size="80"></td>
							    </tr>
							    <tr>
							      <th scope="row">작성내용</th>
							      <td><textarea name="articleContent" cols="100" rpws="100"></textarea></td>
							    </tr>
							  </tbody>
							  	<tr>
							      <th scope="row"></th>
							      <td><button type="button" class="btn btn-primary" onclick="history.go(-1);">이전으로</button>
